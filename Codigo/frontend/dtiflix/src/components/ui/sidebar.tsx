...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          " h-full px-4 py-4 hidden  md:flex md:flex-col dark:bg-neutral-100 bg-neutral-800 w-[300px] shrink-0",
          className,
        )}
        animate={{
  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className="dark:text-neutral-700 text-neutral-200 text-sm group-hover/sidebar:translate-x-1 transition duration-150 whitespace-pre inline-block !p-0 !m-0"
      >
        <div>
          <TextAnimate animation="slideUp" by="word" duration={duration}>
            {link.label}
          </TextAnimate>
        </div>
      </motion.span>
